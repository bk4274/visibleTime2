...
public class GMailSender extends javax.mail.Authenticator {
    ...
    public GMailSender(String user, String password) {
        Log.d(tag,"GMailSender - GMailSender() |  ");
    ...
    public String getEmailCode() {
        Log.d(tag,"GMailSender - getEmailCode() |  ");
        return emailCode;
    } //생성된 이메일 인증코드 반환
    ...
    protected PasswordAuthentication getPasswordAuthentication() {
        Log.d(tag,"GMailSender - getPasswordAuthentication() |  ");
    ...
    public synchronized void sendMail(String subject, String body, String recipients) throws Exception {
        Log.d(tag,"GMailSender - sendMail() |  ");
    ...
    public class ByteArrayDataSource implements DataSource {
        ...
        public ByteArrayDataSource(byte[] data, String type) {
            super();
            Log.d(tag,"ByteArrayDataSource - ByteArrayDataSource() |  ");
            this.data = data;
            this.type = type;
        }
        ...
        public InputStream getInputStream() throws IOException {
            Log.d(tag,"ByteArrayDataSource - getInputStream() |  ");
            return new ByteArrayInputStream(data);
        }

        public String getName() {
            Log.d(tag,"ByteArrayDataSource - getName() |  ");
            return "ByteArrayDataSource";
        }

        public OutputStream getOutputStream() throws IOException {
            Log.d(tag,"ByteArrayDataSource - getOutputStream() |  ");
